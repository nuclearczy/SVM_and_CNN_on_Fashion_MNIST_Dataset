...
def main():
    PRE_TRAINED = 0
    RESNET50_PATH = './weight/FashionMNIST_alexnet.pth'
    ...
    if (PRE_TRAINED):
        alexnet.load_state_dict(torch.load(RESNET50_PATH))
    else:
        ...
        torch.save(alexnet.state_dict(), RESNET50_PATH)
